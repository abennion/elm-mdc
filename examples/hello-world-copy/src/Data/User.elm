module Data.User exposing (User, Username, decoder, encode, stringToUsername, usernameDecoder, usernameParser, usernameToHtml, usernameToString)
...
stringToUsername : String -> Username
stringToUsername username =
    Username username
